...
require_fixed "ImageVersion=0.16.17.18" "$stalwart_service_config"
...
require_fixed "STALWART_PACKAGE_RELEASE=17" "$stalwart_service_release"
require_fixed "IMAGE_VERSION=0.16.17.18" "$stalwart_service_release"
